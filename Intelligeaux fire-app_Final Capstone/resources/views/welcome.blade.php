...
<body>
            ...
            <div class="contaniner">
                <div class="header-main d-flex justify-content-between align-items-center">
                    <div class="header-logo ">
                        <a href="/"><span>Ashesi</span>University</a>
                    </div>
                    ...
                    <nav class="header-menu js-header-menu">
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item menu-item-has-children">
                                <a href="#" class="js-toggle-sub-menu">Login</i></a>
                                <ul class="sub-menu js-sub-menu">
                                    <li class="sub-menu-item"><a href="{{ route('std.login') }}">Student</a></li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children">
                                <a href="#" class="js-toggle-sub-menu">Register</i></a>
                                <ul class="sub-menu js-sub-menu">
                                    <li class="sub-menu-item"><a href="{{ route('std.register') }}">Student</a></li>
                                </ul>
                            </li>
    ...
    <!-- style switcher start -->
     <div class="style-switcher js-style-switcher"> {{-- display: none - removes the theme switcher / when it's taken off style switcher get's enabled --}}
        ...
        <div class="style-switcher-item">
            <div class="form-check form-switch">
                <input class="form-check-input js-dark-mode" type="checkbox" checked role="switch" id="dark-mode">
                <label class="form-check-label" for="dark-mode">Dark Mode</label>
            </div>
        </div>
        <div class="style-switcher-item">
            <div class="form-check form-switch">
                <input class="form-check-input js-glass-effect" type="checkbox" checked role="switch" id="glass-effect">
